...
import { ShoppingBag } from "lucide-react"; // ✅ FIXED IMPORT
            ...
            >
              ...
              <div className="mt-6">
                ...
                <p className="text-lg">
                  ...
                  ,{" "}
                  <span className="font-bold text-blue-600">MongoDB</span>, and
                  integrating{" "}
                  ...
                  ,{" "}
                  <span className="font-bold text-indigo-500">Cloudinary</span>{" "}
                  for file storage, and deploying applications using{" "}
                  <span className="font-bold text-indigo-500">Render</span>.
                  Additionally, I am working on a{" "}
                  <span className="font-bold text-yellow-600">Major project</span>{" "}
